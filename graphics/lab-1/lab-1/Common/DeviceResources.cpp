...
void DX::DeviceResources::CreateWindowSizeDependentResources() 
{
	...
	else
	{
		...
		swapChainDesc.SwapEffect = DXGI_SWAP_EFFECT_FLIP_SEQUENTIAL;	// Все приложения Магазина Windows должны использовать эффект SwapEffect.
	...
	// Сглаживание текста в оттенках серого рекомендуется для всех приложений Магазина Windows.
...
void DX::DeviceResources::Present() 
{
	...
	// перезаписано. Если используются прямоугольники dirty или scroll, этот вызов необходимо удалить.
